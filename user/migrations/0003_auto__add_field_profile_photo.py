...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profile', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.photo'
        db.delete_column('user_profile', 'photo')
    ...
    models = {
        ...
        'user.profile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 1)'}),

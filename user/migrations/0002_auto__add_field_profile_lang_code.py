...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.lang_code'
        db.add_column('user_profile', 'lang_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.lang_code'
        db.delete_column('user_profile', 'lang_code')
    ...
    models = {
        ...
        'user.profile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 2, 10)'}),
